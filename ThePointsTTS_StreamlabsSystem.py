...
ScriptName = "ThePointsTTS"
Creator = "LuisSanchezDev | Edit by travkina"
Version = "1.0"
...
def Execute(data):
  if data.IsChatMessage():
    if SETTINGS["read_all_text"]:
      ...
      return
    elif "msg-id=highlighted-message" in data.RawData:
      TEXTS_QUEUE.append(data.Message)
      return
...
#-----------------------------------------------------------------------#
#  [ThePointsTTS] Changes the pitch, speed and volume of downloaded mp3  #
#-----------------------------------------------------------------------#
...
#-----------------------------------------------------------------------------------------#
#  [ThePointsTTS] Download from Google Translate voice generator using defined TTS language  #
#-----------------------------------------------------------------------------------------#
